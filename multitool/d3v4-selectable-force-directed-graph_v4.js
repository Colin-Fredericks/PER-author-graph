...
function createV4SelectableForceDirectedGraph(svg, graph) {
    ...
    function panToNode(author){
        ...
        d3.selectAll('circle').attr('transform', 'translate('+(xOffset + width*3/2)+','+(yOffset + height*3/2)+')');
        d3.selectAll('line').attr('transform', 'translate('+(xOffset + width*3/2)+','+(yOffset + height*3/2)+')');
        d3.selectAll('text').attr('transform', 'translate('+(xOffset + width*3/2)+','+(yOffset + height*3/2)+')');
