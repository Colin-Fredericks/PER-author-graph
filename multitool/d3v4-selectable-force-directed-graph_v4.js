...
function createV4SelectableForceDirectedGraph(svg, graph) {
    ...
    function panToNode(author){
        ...
        d3.selectAll('circle').attr('transform', 'translate('+(xOffset + width)+','+(yOffset + height)+')');
        d3.selectAll('line').attr('transform', 'translate('+(xOffset + width)+','+(yOffset + height)+')');
        d3.selectAll('text').attr('transform', 'translate('+(xOffset + width)+','+(yOffset + height)+')');
